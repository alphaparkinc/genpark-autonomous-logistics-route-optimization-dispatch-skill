# genpark-autonomous-logistics-route-optimization-dispatch-skill
...
> **GenPark AI Agent Skill** -- Autonomous logistics dispatch and multi-agent vehicle route optimization engine (FarEye style)
